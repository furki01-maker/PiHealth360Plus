...
const dbName = environments_1.default.mongo_db_name;
const mongoUri = `mongodb://${environments_1.default.mongo_host}/${dbName}`;
...
app.listen(8000, () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const client = yield mongodb_1.MongoClient.connect(mongoUri, mongoClientOptions);
