...
var platformAPIClient_1 = require("../services/platformAPIClient");
...
function mountPaymentsEndpoints(router) {
    ...
    router.post('/complete', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var app, paymentId, txid, orderCollection;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    app = req.app;
                ...
                case 2:
                    // let Pi server know that the payment is completed
                    _a.sent();
                    return [2 /*return*/, res.status(200).json({ message: "Completed the payment ".concat(paymentId) })];
            }
        });
    }); });
